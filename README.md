...
##### Status: Complete Revamp Needed
  ...
  This was done in an early version of unity and all the prefab assets were lost in it. Beyond that, it was my first attempt to make any type of AI, and I was a complete amateur when I started. Learned a lot about pathfinding amd state machines and tilesets, but honestly it was pretty disgusting code so I'm not too upset to lose a lot of the data.
